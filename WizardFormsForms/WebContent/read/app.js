...
.config(function($routeProvider, $datepickerProvider) {
  $routeProvider
    ...
    .when('/get/:formid/:verformid/:token', {      
      templateUrl:'views/read.html',
      controller:'ReadCtrl'
    })
    .otherwise({
...
.controller('ReadCtrl', function($scope, $compile, $routeParams, $http) {
...
function addRadio(elmparent,field,formid,seccion,$scope,$compile){	
	...
	newDivButton.setAttribute("readOnly", "true" );
